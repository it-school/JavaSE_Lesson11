...
public class Main {
    public static void main(String[] args) {
        Ingredient i1 = new Ingredient("Sugar", Measurements.чайн_л, "свекольный");
        Ingredient i2 = new Ingredient("Tea", Measurements.чайн_л, "India");
        Ingredient i3 = new Ingredient("Lemon", Measurements.долька, "Эквадор");
        Ingredient i4 = new Ingredient("Coffee", Measurements.чайн_л, "Brazil");
